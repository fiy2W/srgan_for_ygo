...
def Vgg19_simple_api(rgb, reuse):
    ...
    with tf.variable_scope("VGG19", reuse=reuse):
        ...
        """ conv2 """
        network = tl.layers.Conv2d(network, n_filter=128, filter_size=(3, 3), strides=(2, 2), act=tf.nn.relu, padding='SAME', name='conv2_1')
        ...
        """ conv3 """
        network = tl.layers.Conv2d(network, n_filter=256, filter_size=(3, 3), strides=(2, 2), act=tf.nn.relu, padding='SAME', name='conv3_1')
        ...
        """ conv4 """
        network = tl.layers.Conv2d(network, n_filter=512, filter_size=(3, 3), strides=(2, 2), act=tf.nn.relu, padding='SAME', name='conv4_1')
        ...
        """ conv5 """
        network = tl.layers.Conv2d(network, n_filter=512, filter_size=(3, 3), strides=(2, 2), act=tf.nn.relu, padding='SAME', name='conv5_1')
